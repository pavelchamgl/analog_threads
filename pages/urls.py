...
urlpatterns = [
    ...
    re_path('post/(?P<user_id>.+)/list/', views.UserPostsListAPIView.as_view(), name='posts-by-user_id'),
    ...
    path('notifications/<str:type>/', views.NotificationsByTypeView.as_view(), name='user_notifications'),
]
